...
class Connector():
    ...
    def csv_to_drive(self, creds):
        service = build('drive', 'v3', credentials=creds)

        file_metadata = {'name': 'Fighter-Data'}
        media = MediaFileUpload('data/data.csv')
...
def connect():
    ...
    creds = connection.establish_connection()
    connection.csv_to_drive(creds)
